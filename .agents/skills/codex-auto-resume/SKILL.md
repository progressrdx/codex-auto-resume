...
Use the repository's `./resume` entrypoint. Do not call private modules directly or rewrite the launcher.

## Workflow

- For readiness, run `./resume doctor`. This is read-only.
